...
-- Sleep rows: identity is (user_id, sleep_date). date_md is legacy display/sync text (ISO); not unique.
...
-- Used by promote_draft_if_complete and migrations; not exposed to PostgREST callers.
